...
public class Display extends JFrame {
  ...
  public Display() {
    ...
    JLabel lblTiming_1 = new JLabel("Durée Dijkstra : ");
    GridBagConstraints gbc_lblTiming_1 = new GridBagConstraints();
    gbc_lblTiming_1.insets = new Insets(0, 0, 5, 0);
    gbc_lblTiming_1.fill = GridBagConstraints.HORIZONTAL;
    gbc_lblTiming_1.gridx = 2;
    gbc_lblTiming_1.gridy = 6;
    contentPane.add(lblTiming_1, gbc_lblTiming_1);

    JLabel lblTiming_2 = new JLabel("Durée depshort : ");
    GridBagConstraints gbc_lblTiming_2 = new GridBagConstraints();
    gbc_lblTiming_2.insets = new Insets(0, 0, 5, 0);
    gbc_lblTiming_2.fill = GridBagConstraints.HORIZONTAL;
    gbc_lblTiming_2.gridx = 4;
    gbc_lblTiming_2.gridy = 6;
    contentPane.add(lblTiming_2, gbc_lblTiming_2);

    JButton btnDrawWeightedShortest2 = new JButton("Draw other Path");
    btnDrawWeightedShortest2.setForeground(Color.BLUE);
    GridBagConstraints gbc_btnDrawWeightedShortest2 = new GridBagConstraints();
    gbc_btnDrawWeightedShortest2.fill = GridBagConstraints.HORIZONTAL;
    gbc_btnDrawWeightedShortest2.insets = new Insets(0, 0, 5, 0);
    gbc_btnDrawWeightedShortest2.gridx = 5;
    gbc_btnDrawWeightedShortest2.gridy = 6;
    contentPane.add(btnDrawWeightedShortest2, gbc_btnDrawWeightedShortest2);
    ...
    btnDrawWeightedShortest.addMouseListener(new MouseAdapter() {
      ...
      public void mouseReleased(MouseEvent e) {
        ...
        lblTiming_1.setText("Durée Dijkstra : " + timeElapsed +"ns");
        System.out.println("la durée d'exécution est de : "+timeElapsed);
        panel.overlayEdges.put("weighted", weightedPath);
        repaint();
      }
    });

    btnDrawWeightedShortest2.addMouseListener(new MouseAdapter() {
      @Override
      public void mouseReleased(MouseEvent e) {
        String startCity = weightedStartCityComboBox.getItemAt(weightedStartCityComboBox.getSelectedIndex());
        String endCity = weightedEndCityComboBox.getItemAt(weightedEndCityComboBox.getSelectedIndex());
        System.out.println("Calculating shortest weighted path for " + startCity + " to " + endCity);
        long start = System.nanoTime();
        List<Edge> weightedPath = dijkstra.getdepthCoursePath(startCity, endCity);
        long timeElapsed = System.nanoTime() - start;
        lblTiming_2.setText("Durée parcours en profondeur : " + timeElapsed +"ns");
        System.out.println("la durée d'exécution est de : "+timeElapsed);
